...
describe Rapns::Apns::ActiveRecord::Notification, 'MDM' do
  let(:magic) { 'abc123' }
  let(:notification) { Rapns::Apns::ActiveRecord::Notification.new }
...
describe Rapns::Apns::ActiveRecord::Notification, 'content-available' do
  let(:notification) { Rapns::Apns::ActiveRecord::Notification.new }
...
describe Rapns::Apns::ActiveRecord::Notification, "to_binary" do
...
describe Rapns::Apns::ActiveRecord::Notification, "bug #31" do
...
describe Rapns::Apns::ActiveRecord::Notification, "bug #35" do
  it "should limit payload size to 256 bytes but not the entire packet" do
    notification = Rapns::Apns::ActiveRecord::Notification.new do |n|
      n.device_token = "a" * 64
      n.alert = "a" * 210
...
describe Rapns::Apns::ActiveRecord::Notification, "multi_json usage" do
  describe Rapns::Apns::ActiveRecord::Notification, "alert" do
    it "should call MultiJson.load when multi_json version is 1.3.0" do
      notification = Rapns::Apns::ActiveRecord::Notification.new(:alert => { :a => 1 }, :alert_is_json => true)
